...
<?php if ( $_GET && key_exists('mfn-rtl', $_GET) ) : ?>
    <html class="no-js" lang="ar" dir="rtl">
<?php else : ?>
    <html <?php language_attributes( ) ?> class="no-js<?= esc_attr( mfn_user_os( ) ) ?>" <?php mfn_tag_schema( ) ?>>
<?php endif; ?>
...
<body <?= body_class( ( is_product() and !has_term( 'menus','product_cat' ) ) ? [ 'simple-product', 'Rebell' ] : [ 'Rebell' ] ) ?>>
    ...
    <div id="Wrapper">
        ...
        <div 
            ...
            <?php if ( $data_parallax ) printf('%s="%.1f"', $data_parallax['key'], $data_parallax['value']) ?>
        >
            ...
            if (
                !mfn_slider_isset( $shop_id ) or
                is_product( ) or
                ( is_array( $subheader_advanced ) && isset( $subheader_advanced[ 'slider-show' ] ) )
            ) :
                    ...
                    <div id="Subheader">
                        <div class="container">
                            <div class="column one"><?php
                                ...
                                if ( $breadcrumbs_show ) :
                                    $home = mfn_opts_get( 'translate' )
                                        ? mfn_opts_get( 'translate-home', 'Home' )
                                        : __( 'Home', 'betheme' );

                                    $woo_crumbs_args = apply_filters( 'woocommerce_breadcrumb_defaults', [
                                        'delimiter'   => false,
