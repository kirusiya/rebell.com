 ...
 */
    ...
    *::after {
    ...
    body {
      margin: 0;
      font-family: 'Courier Prime', courier-std, monospace;
      font-size: 1rem;
      font-weight: 400;
      line-height: 1.5;
      color: #212529;
    ...
    .ftco-intro .wrap .social .social-icon div {
      list-style: none;
      display: inline-block;
      line-height: 0;
      padding: 0 5px;
    ...
    .pricing-entry .text:after {
      ...
      width: 100%;
      height: 1px;
      border-bottom: 1px dashed #F6E81D;
      z-index: -1;
    }
    ...
    .search-form .form-group input {
      ...
      background: transparent !important;
      border: none;
      border-bottom: 1px solid #F6E81D;
      color: rgba(255, 255, 255, 0.7);
    }
...
<body>
    <app class="app">
        <div class="container" style="align-content: center">
		   ...
		   <div app>
              <h4>Ya puedes hacer tus pedidos a través de la App</h4> 
           </div>
		       <a href="https://apps.apple.com/es/app/rebell/id1540597466">
                   <img src="web/images/app-store.png" class="img-fluid" alt=""></a>
		       <a href="https://play.google.com/store/apps/details?id=com.rebell.customer">
		           <img src="web/images/google-play.png" class="img-fluid" alt=""></a>
        </div>
		<div>
			 <img src="web/images/cuernos.png" class="img-fluid" alt="">
		</div>
    </app>
</body>
